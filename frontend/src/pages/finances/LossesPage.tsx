...
export default function LossesPage() {
  ...
  const [form, setForm] = useState({
    ...
    reason: 'EXPIRATION' as LossReason,
    note: '',
  });
              ...
              <TableBody>
                {losses.map((l) => (
                  <TableRow key={l.id}>
                    ...
                    <TableCell align="right" sx={{ color: diane.red, fontWeight: 700 }}>
                      {formatFcfa(l.totalValue)}
                    </TableCell>
        ...
        <DialogContent>
          <Stack spacing={2} sx={{ mt: 1 }}>
            ...
            <TextField
              ...
              label="Reason"
              value={form.reason}
              onChange={(e) => setForm({ ...form, reason: e.target.value as LossReason })}
              fullWidth
            >
